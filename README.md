...
<ul>
 <li> This website was developed with the purpose of using as a business card for the product we are developing.</li>
</ul>
...
<ul>
 <li>Clone this repo and open the project.</li>
